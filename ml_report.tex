...
\begin{document}
  ...
  %\tableofcontents
  \begin{abstract}
    This report compares the effectiveness of neural nets and probabilistic techniques on classifying sentences taken from horror stories written by three different authors. The report also looks at the different
  \end{abstract}
