...
\end{table}
  ...
  \subsection{kPCA}
  \label{sec:kpca}
    An attempt was made to use kernel principal component analysis (kPCA) to help to produce more separable data. To do this a kPCA was used on a Count Vectorizer and a Term Frequency – Inverse Document Frequency Vectorizer. The idea behind this is to try to make the data points more separable. Although a variety of kernels were used and different vectorizers none were able to improve the separation of data significantly.
